import { ListRecentQuestionResultsTool } from './list-recent-question-results.tool';
...
describe('ListRecentQuestionResultsTool', () => {
  let tool: ListRecentQuestionResultsTool;
  let exercisesService: jest.Mocked<QuestionsService>;
  ...
  beforeEach(() => {
    ...
    tool = new ListRecentQuestionResultsTool(exercisesService);
  });
  ...
  describe('execute', () => {
    ...
    it('calls QuestionsService.getUserResults with ctx.userId and parsed limit', async () => {
