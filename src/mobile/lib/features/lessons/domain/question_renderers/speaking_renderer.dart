...
class SpeakingRenderer extends QuestionRenderer {
  const SpeakingRenderer();

  @override
  QuestionType get type => QuestionType.speaking;
  ...
  Widget buildInput(
    ...
    final options = question.options as SpeakingOptions;
    return _SpeakingInput(
      questionId: question.id,
      promptText: options.promptText,
      promptAudioUrl: question.questionAudioUrl ?? options.promptAudioUrl,
...
class _SpeakingInputState extends State<_SpeakingInput>
  ...
  Widget build(BuildContext context) {
    ...
    final visuals = getQuestionVisuals(context, QuestionType.speaking);
