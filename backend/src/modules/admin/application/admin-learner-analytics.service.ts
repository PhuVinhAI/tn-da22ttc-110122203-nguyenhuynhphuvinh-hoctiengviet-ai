...
import {
  computeLearnerHealth,
  buildLearnerInsights,
} from './dashboard-learner-insights.util';
...
export class AdminLearnerAnalyticsService {
  ...
  async getAnalytics(userId: string) {
    ...
    const health = computeLearnerHealth({
  ...
  // Health/risk scoring and auto-insights live in dashboard-learner-insights.util.ts
  // (pure functions, unit-testable in isolation — mirrors dashboard-time.util.ts).
}
